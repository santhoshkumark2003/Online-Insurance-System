            ...
            <div class="row">
                <div class="col-lg-8 posts-list">
                    <form action="policyreg.php" method="post">
                        ...
                        <div class="mt-10">
                            <input type="text" name="idno" placeholder="Aadhar Number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Aadhar Number'" required class="single-input-primary">
                        </div>
                        <div class="mt-10">
                        ...
                        <div class="mt-10" align="center">
                           <!-- Apply Policy Button -->
<button type="button" name="submitreg" class="genric-btn success-border"
    onclick="applyPolicy()">
    Apply Policy
</button>

<!-- Cancel Button -->
<button style="margin-left: 50px" type="reset" name="submitreg" class="genric-btn danger-border"
    onclick="return confirmCancel();">
    <a href="home.php" style="color: inherit; text-decoration: none;">Cancel Registration</a>
</button>

<!-- Script for alerts -->
<script>
    function applyPolicy() {
        // Optionally validate form fields here
        alert("Policy Applied Successfully!");
        // If needed, submit the form here manually:
        // document.getElementById("yourFormId").submit();
    }

    function confirmCancel() {
        return confirm("Are you sure you want to cancel registration and return to Home?");
    }
</script>
